...
const NewContact = ({ open, handleOpenNewContact, buttonActive, setOpenFormView }) => {
  ...
  const validateFieldList = {
    // contact_code: true,
    contact_name: buttonActive === 'brokers_and_agents' ? false : true,
    contact_person: buttonActive === 'brokers_and_agents' ? false : true,
    department: buttonActive === 'employee' ? true : false,
    contact_number: true,
    contact_company: buttonActive === 'brokers_and_agents' ? true : false,
    contact_broker_agent: buttonActive === 'brokers_and_agents' ? true : false,
    floor_no: true,
    building_name: true,
    street: true,
    zip_code: false,
  ...
  const [contactType, setContactType] = useState('BROKERS');
  ...
  const handleSaveContact = () => {
    ...
    if (buttonActive === 'brokers_and_agents') {
      ...
      newContact.name = contactCompany;
      newContact.contact_person = contactBrokerAgent;
    }

    console.log(newContact, 'NEW CONTACT DATA');

    dispatch(CONTACT.saveNewContact(newContact, buttonActive, setOpenFormView, handleOpenNewContact));
  };
                          ...
                          <CardContent className={classes.headerBG}>
                            ...
                            <div className={classes.contentItemStyle}>
                              ...
                              >
                                ...
                                <FormHelperText id="code-helper-text" classes={{ root: classes.codeHelperTextRoot }}>
                                  Note: Actual Code will be generated after successfully saving the new contact
                                  information
                                </FormHelperText>
                              </FormControl>
                            </div>
